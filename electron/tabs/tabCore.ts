...
import { setActiveTab } from '../shared/database'
...
export function createTabCore(tabInfo: TabInfo, afterTabId?: string, externalId?: string): { view: WebContentsView; tabInfo: TabInfo; insertIndex: number } {
